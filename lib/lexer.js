(function(){
  ...
  exports.Lexer = (function() {
    ...
    Lexer.prototype.string_token = function string_token() {
      ...
      this.line = this.line + count(string, "\n");
      this.i = this.i + string.length;
      return true;
    };
    ...
    Lexer.prototype.regex_token = function regex_token() {
      ...
      regex = regex + ((flags = this.chunk.substr(regex.length).match(REGEX_FLAGS)));
    ...
    Lexer.prototype.comment_token = function comment_token() {
      ...
      this.line = this.line + (comment.match(MULTILINER) || []).length;
    ...
    Lexer.prototype.line_token = function line_token() {
      ...
      this.line = this.line + indent.match(MULTILINER).length;
      this.i = this.i + indent.length;
      prev = this.prev(2);
